...
class Widget_Part_Side(CTkFrame):
    ...
    def build_ui(self):
        ...
        self.label_title = CTkLabel(self.frame_main, text = "Part Side",
        ...
        self.label_partside = CTkLabel(self.frame_body, text = "##",
                                    fg_color = Color().transparent,
                                    font = (Font().font_bold, 96),
                                    text_color = Color().black)
        self.label_partside.grid(row = 0, column = 0)
    
    def update_label(self, text : str):
        self.label_partside.configure(text = text)
