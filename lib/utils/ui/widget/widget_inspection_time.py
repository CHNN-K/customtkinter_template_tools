...
class Widget_Inspection_Time(CTkFrame):
    ...
    def build_ui(self):
        ...
        self.label_title = CTkLabel(self.frame_main, text = "Inspection time",
        ...
        self.label_inspection_time = CTkLabel(self.frame_body, text = "99.99s",
                                    fg_color = Color().transparent,
                                    font = (Font().font_bold, 64),
                                    text_color = Color().black)
        self.label_inspection_time.grid(row = 0, column = 0)
    
    def update_label(self, time : float):
        self.label_inspection_time.configure(text = f"{time:.2f}s")
